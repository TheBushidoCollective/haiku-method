...
### V-08
- `packages/haiku/src/http/auth.ts` — `csrfPreHandler`, `isOriginAllowed`, `mintCsrfNonce` / `getCsrfNonce`, `registerCsrfRoutes`, `/api/csrf-nonce` endpoint
