...
- **[AI-DLC](https://ai-dlc.dev)** — Software development profile
- **SWARM** — Marketing & sales profile
...
- Website: [haikumethod.ai](https://haikumethod.ai)
- Paper: [Full methodology paper](https://haikumethod.ai/paper)

## License

Copyright The Bushido Collective. All rights reserved.
