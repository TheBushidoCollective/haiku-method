...
- Per-orphan or per-broken-reference: `haiku_feedback({ origin: "engine-review", author: "continuity", source_ref: "continuity:<path>", target_unit: <best guess or null>, target_invalidates: [] })`
