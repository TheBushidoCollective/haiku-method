...
export const WORKFLOW_CONTRACTS_ELABORATE_BLOCK = [
	...
	"",
	"Two passes that prevent the spec-quality failures the workflow engine cannot catch on its own. Both are studio-agnostic — the *content* differs by domain, the *gesture* does not.",
	"",
	...
	"1. <stack / architecture / data-model assumption>",
