...
// provider-auth MCP tools (haiku_auth_status, haiku_auth_logout,
// haiku_auth_login, haiku_upload_proof) over the global token store
// (~/.haiku/settings.json). Phase 1 is the read/clear surface; Phase 3 adds
// the broker login handshake; Phase 5 adds provider proof upload.
//
