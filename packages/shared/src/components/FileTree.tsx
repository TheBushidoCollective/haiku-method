	...
	return (
		<div>
			...
			>
				...
				<span
					className={`font-mono text-xs ${item.isDirectory ? "text-stone-600 dark:text-stone-400 font-medium" : "text-stone-500 dark:text-stone-400"}`}
				>
					{item.name}
				</span>
			</button>
			...
			{expanded && !hasChildren && renderContent && (
				<div
					className="border-t border-stone-100 px-4 py-4 dark:border-stone-800"
