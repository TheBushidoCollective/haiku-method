...
export function MarkdownViewer({ children, id, className = "" }: Props) {
	return (
		<div
			id={id}
        ...
        prose-td:border prose-td:border-stone-300 prose-td:dark:border-stone-600 prose-td:px-3 prose-td:py-1.5 ${className}`}
		>
