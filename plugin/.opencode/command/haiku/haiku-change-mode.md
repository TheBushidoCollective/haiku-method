...
- **Cannot change mode pre-studio.** If `studio` isn't set yet, the intent hasn't reached mode selection — use `/haiku:haiku-start` to drive the initial elicitation chain instead of this skill.
