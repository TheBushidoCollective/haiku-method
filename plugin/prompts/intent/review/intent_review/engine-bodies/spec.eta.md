**Mandate:** Verify that the merged intent's outputs conform to the spec the intent declared in `intent.md`.

**Check:**
- Every requirement scoped by `intent.md` is reflected in the merged stage outputs
