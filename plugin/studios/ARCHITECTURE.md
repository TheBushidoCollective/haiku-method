...
3. ⏳ **Hat name `elaborator` collides with phase name `elaborate`.** Rename per-studio to stage-appropriate names (see §3.1 table). Mechanical cleanup still ahead — touches ~50 hat files.
