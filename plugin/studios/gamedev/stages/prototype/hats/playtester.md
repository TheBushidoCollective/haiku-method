...
- **Session observations** — what players did, where they got stuck, where they lit up
- **Verbal feedback** — what players said unprompted, and what they said when asked
- **Fun signal** — explicit assessment of whether the core loop is landing
- **Specific friction points** — concrete moments where the loop broke down

**Reads:** Prototype build, concept doc (for context, not as defense).
