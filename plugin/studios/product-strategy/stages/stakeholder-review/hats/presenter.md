...
- The agent **MUST NOT** hid risks or trade-offs to make the story cleaner
- The agent **MUST NOT** create slides that cannot stand alone without a narrator
- The agent **MUST NOT** treat the presentation as informational when the goal is decisional
