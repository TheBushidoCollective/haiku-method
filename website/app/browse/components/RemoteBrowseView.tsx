		...
		async function init() {
			...
			try {
				const status = isGitHub
					...
					: {
							ok: await (prov as GitLabProvider).isAccessible(),
	...
	if (needsAuth) {
		return (
			<div className="mx-auto max-w-xl px-4 py-16">
				...
				<h1 className="mb-2 text-2xl font-bold">Sign In to Browse</h1>
					...
					<div className="mb-6 rounded-xl border border-stone-200 p-6 dark:border-stone-700">
						...
						>
							{isGitHub ? (
								...
								>
									<path
										d="M190.1 347.5L256.4 143.1H123.8L190.1 347.5Z"
										fill="#E24329"
									/>
									<path
										d="M190.1 347.5L123.8 143.1H18.3L190.1 347.5Z"
										fill="#FC6D26"
									/>
									<path
										d="M18.3 143.1L1.5 194.8C0 199.5 1.5 204.8 5.5 207.7L190.1 347.5L18.3 143.1Z"
										fill="#FCA326"
									/>
									<path
										d="M18.3 143.1H123.8L81.9 14.2C79.8 7.6 70.2 7.6 68.1 14.2L18.3 143.1Z"
										fill="#E24329"
									/>
									<path
										d="M190.1 347.5L256.4 143.1H361.9L190.1 347.5Z"
										fill="#FC6D26"
									/>
									<path
										d="M361.9 143.1L378.7 194.8C380.2 199.5 378.7 204.8 374.7 207.7L190.1 347.5L361.9 143.1Z"
										fill="#FCA326"
									/>
									<path
										d="M361.9 143.1H256.4L298.3 14.2C300.4 7.6 310 7.6 312.1 14.2L361.9 143.1Z"
										fill="#E24329"
									/>
								</svg>
							)}
