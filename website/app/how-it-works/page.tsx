...
const stageLoop = [
	{
		...
		description:
			"The planner hat reads the stage definition (STAGE.md), prior stage artifacts, and global knowledge. It elaborates the stage's work into units with verifiable completion criteria.",
	...
	},
	{
		...
		description:
			"The gate determines what happens next. Four modes: auto (advance immediately), ask (pause for user), await (wait for async signal), external (block for team review). The studio's stage definition declares which mode.",
		output:
			"Advance to next stage, revise within stage, or revisit earlier stage",
	},
]
...
const dagExample = [
	...
	{ id: "unit-03", name: "Auth middleware", deps: "unit-01", status: "active" },
	{
		...
		deps: "unit-02, unit-03",
		status: "blocked",
	},
	{
		id: "unit-05",
		name: "Integration tests",
		deps: "unit-02, unit-03, unit-04",
		status: "blocked",
	},
]
	...
	return (
		<div>
			...
			<section className="px-4 py-16 sm:py-24">
				<div className="mx-auto max-w-3xl text-center">
					...
					<p className="text-lg text-stone-600 dark:text-stone-400">
						...
						DAG-based unit management, environment-detected persistence, and
						concrete examples of what happens under the hood.
					</p>
				</div>
			</section>
				...
				<div className="mx-auto max-w-5xl">
					<div className="mb-10 text-center">
						...
						<p className="mx-auto max-w-2xl text-stone-600 dark:text-stone-400">
							Before any autonomous work begins, human and AI collaborate to
							define what gets built, why, and how success is measured. This is
							the most important phase — it determines everything that follows.
						</p>
					</div>
					...
					<div className="grid gap-6 md:grid-cols-2">
						...
						<div className="rounded-xl border-2 border-teal-200 bg-teal-50/30 p-6 dark:border-teal-800 dark:bg-teal-950/10">
							...
							<div className="space-y-3">
								<div className="rounded-lg bg-white/70 p-3 dark:bg-stone-950/40">
									<div className="mb-1 text-sm font-semibold text-teal-700 dark:text-teal-300">
										Intent
									</div>
									<p className="text-xs text-stone-600 dark:text-stone-400">
										Describes the problem and desired outcome in natural
										language. No templates required — just explain what you want
										to accomplish.
									</p>
								</div>
								<div className="rounded-lg bg-white/70 p-3 dark:bg-stone-950/40">
									...
									<p className="text-xs text-stone-600 dark:text-stone-400">
										Studio selection, mode choice (continuous/discrete), and
										review gate approvals. The human controls the
										&ldquo;what&rdquo; and &ldquo;when&rdquo; — the AI proposes,
										the human decides.
									</p>
								</div>
								<div className="rounded-lg bg-white/70 p-3 dark:bg-stone-950/40">
									...
									<p className="text-xs text-stone-600 dark:text-stone-400">
										Reviews the AI&apos;s proposed completion criteria and unit
										elaboration. Adjusts scope, adds constraints, removes
										unnecessary work.
									</p>
								</div>
							</div>
						...
						<div className="rounded-xl border-2 border-indigo-200 bg-indigo-50/30 p-6 dark:border-indigo-800 dark:bg-indigo-950/10">
							...
							<div className="space-y-3">
								<div className="rounded-lg bg-white/70 p-3 dark:bg-stone-950/40">
									<div className="mb-1 text-sm font-semibold text-indigo-700 dark:text-indigo-300">
										Discovery
									</div>
									<p className="text-xs text-stone-600 dark:text-stone-400">
										Explores the codebase, reads documentation, identifies
										patterns and constraints. Produces a discovery doc that
										grounds all subsequent work.
									</p>
								</div>
								<div className="rounded-lg bg-white/70 p-3 dark:bg-stone-950/40">
									<div className="mb-1 text-sm font-semibold text-indigo-700 dark:text-indigo-300">
									...
									<p className="text-xs text-stone-600 dark:text-stone-400">
										Breaks the intent into units with dependencies (a DAG). Each
										unit has specific, verifiable completion criteria — not
										vague descriptions, but checkboxes the reviewer can verify.
									</p>
								</div>
								<div className="rounded-lg bg-white/70 p-3 dark:bg-stone-950/40">
									<div className="mb-1 text-sm font-semibold text-indigo-700 dark:text-indigo-300">
									...
									<p className="text-xs text-stone-600 dark:text-stone-400">
										Proposes the technical approach, identifies risks, and maps
										units to stages. The human reviews before any building
										starts.
									</p>
								</div>
							</div>
					...
					<div className="mt-8 rounded-xl border border-stone-200 bg-white p-6 dark:border-stone-800 dark:bg-stone-950">
							...
							<div className="rounded-lg border-2 border-green-200 bg-green-50/30 p-4 dark:border-green-800 dark:bg-green-950/10">
								...
								<div className="space-y-2 text-xs text-stone-600 dark:text-stone-400">
									<p>
										...
										Human and AI collaborate interactively — AI proposes, human
										refines, until criteria are approved.
									</p>
									<p>
										<strong className="text-stone-900 dark:text-stone-100">
											Execution:
										</strong>{" "}
										AI drives autonomously through the stage pipeline. Each
										stage runs its own hat sequence (defined in STAGE.md),
										advancing to the next stage when the review gate passes.
										Gates set to{" "}
							...
							<div className="rounded-lg border-2 border-purple-200 bg-purple-50/30 p-4 dark:border-purple-800 dark:bg-purple-950/10">
								...
								<div className="space-y-2 text-xs text-stone-600 dark:text-stone-400">
									<p>
										...
										Same interactive process — AI proposes criteria and
										elaboration, human validates.
									</p>
									<p>
										<strong className="text-stone-900 dark:text-stone-100">
											Execution:
										...
										for development, or
										threat-modeler→red-team→blue-team→security-reviewer for
										security), but it stops after the stage completes.
									</p>
									<p>
										<strong className="text-stone-900 dark:text-stone-100">
											Human re-enters at:
										</strong>{" "}
										Every stage boundary. The human decides when to proceed,
										skip stages, or revise previous work. Maximum control over
										the pipeline.
									</p>
								</div>
							</div>
						...
						<p className="mt-4 text-center text-sm text-stone-500 dark:text-stone-400">
							In both modes, elaboration is always collaborative. The difference
							is who drives the stage transitions during execution.
						</p>
					</div>
				</div>
			</section>
			...
			<section className="px-4 py-16">
				<div className="mx-auto max-w-5xl">
					<div className="mb-10 text-center">
						<h2 className="mb-3 text-3xl font-bold">The Stage Loop</h2>
						<p className="mx-auto max-w-2xl text-stone-600 dark:text-stone-400">
					...
					<div className="mb-8 flex flex-wrap items-center justify-center gap-3">
						{stageLoop.map((step, i) => (
							<div key={step.phase} className="flex items-center gap-3">
								<div
									className={`rounded-xl border-2 px-5 py-3 text-center ${step.color}`}
								>
					...
					<div className="mt-8 rounded-xl border border-stone-200 bg-white p-6 dark:border-stone-800 dark:bg-stone-950">
						...
						<div className="grid gap-4 md:grid-cols-3">
							<div className="rounded-lg bg-green-50 p-4 dark:bg-green-950/20">
								...
								<p className="text-xs text-stone-600 dark:text-stone-400">
									All criteria met. Stage artifacts saved. Move to the next
							...
							<div className="rounded-lg bg-amber-50 p-4 dark:bg-amber-950/20">
								...
								<p className="text-xs text-stone-600 dark:text-stone-400">
									Review found issues. Loop back within this stage — builder
									fixes, reviewer re-evaluates. Same stage, new bolt.
								</p>
							</div>
							<div className="rounded-lg bg-rose-50 p-4 dark:bg-rose-950/20">
								...
								<p className="text-xs text-stone-600 dark:text-stone-400">
									Fundamental issue discovered. Return to a previous stage. Rare
									but supported — e.g., design stage reveals inception was
									incomplete.
								</p>
							</div>
						</div>
			...
			<section className="px-4 py-16">
				<div className="mx-auto max-w-5xl">
					<div className="mb-10 text-center">
						<h2 className="mb-3 text-3xl font-bold">Hats Within Stages</h2>
						<p className="mx-auto max-w-2xl text-stone-600 dark:text-stone-400">
					...
					<div className="grid gap-6 md:grid-cols-2">
						...
						<div className="rounded-xl border border-indigo-200 bg-indigo-50/50 p-6 dark:border-indigo-800 dark:bg-indigo-950/20">
							...
							<p className="mt-4 text-xs text-stone-500 dark:text-stone-400">
								Each hat reads the same STAGE.md definition but has different
								constraints. The planner cannot write code. The builder cannot
								modify criteria. The reviewer cannot be the same agent that
								built.
							</p>
						</div>
						...
						<div className="rounded-xl border border-rose-200 bg-rose-50/50 p-6 dark:border-rose-800 dark:bg-rose-950/20">
							...
							<p className="mt-4 text-xs text-stone-500 dark:text-stone-400">
								...
								&ldquo;external&rdquo; — requires human sign-off before
								advancing.
							</p>
						</div>
					</div>
						...
						<div className="grid gap-4 md:grid-cols-3">
							<div>
								...
								<p className="text-sm text-stone-600 dark:text-stone-400">
									...
									what it needs — stage definition, prior artifacts, knowledge
									pool.
								</p>
							</div>
							<div>
								...
								<p className="text-sm text-stone-600 dark:text-stone-400">
									A hat definition specifies what the agent MUST do, MUST NOT
									do, and what quality gates it must pass before finishing.
								</p>
							</div>
							<div>
								<h4 className="mb-1 text-sm font-semibold text-stone-900 dark:text-stone-100">
								...
								<p className="text-sm text-stone-600 dark:text-stone-400">
									The reviewer never shares context with the builder. It
									evaluates work from scratch, catching issues the builder is
									blind to.
								</p>
							</div>
						</div>
			...
			<section className="border-y border-stone-200 bg-stone-50 px-4 py-16 dark:border-stone-800 dark:bg-stone-900/50">
				<div className="mx-auto max-w-5xl">
					<div className="mb-10 text-center">
						...
						<p className="mx-auto max-w-2xl text-stone-600 dark:text-stone-400">
							Units are organized as a directed acyclic graph (DAG).
							Dependencies between units determine execution order. The DAG
							resolver picks the next &ldquo;ready&rdquo; unit — one whose
					...
					<div className="rounded-xl border border-stone-200 bg-white p-6 dark:border-stone-800 dark:bg-stone-950">
							...
							<table className="w-full text-sm">
								<thead>
									<tr className="border-b border-stone-200 dark:border-stone-700">
										<th className="pb-2 text-left font-semibold text-stone-900 dark:text-stone-100">
											Unit
										</th>
										<th className="pb-2 text-left font-semibold text-stone-900 dark:text-stone-100">
											Name
						...
						<div className="mt-4 rounded-lg bg-stone-50 p-4 text-sm dark:bg-stone-900">
							<p className="text-stone-600 dark:text-stone-400">
								The TypeScript orchestrator evaluates unit frontmatter to
								determine execution order. Unit 03 (auth middleware) is
								currently active because its sole dependency (unit 01) is
								complete. Unit 04 is blocked — it needs both unit 02 and unit 03
								to finish first.
							</p>
						</div>
					</div>
...
4. Write integration tests`}</pre>
						...
						<p className="mt-3 text-sm text-stone-600 dark:text-stone-400">
							The frontmatter is machine-readable. The DAG resolver reads{" "}
							<code>status</code> and <code>depends_on</code> to determine
							order. The reviewer reads <code>criteria</code> to evaluate
							completion. The body is human context for the builder.
						</p>
					</div>
				</div>
			</section>
			...
			<section className="px-4 py-16">
				<div className="mx-auto max-w-5xl">
					<div className="mb-10 text-center">
						<h2 className="mb-3 text-3xl font-bold">Persistence Adapters</h2>
						<p className="mx-auto max-w-2xl text-stone-600 dark:text-stone-400">
							Persistence is environment-detected, not studio-configured. If
							you&apos;re in a git repo, state is committed and pushed. If not,
							it&apos;s files on disk. Studios don&apos;t need to know or care.
						</p>
					</div>
						...
						<table className="w-full text-sm">
							<thead>
								<tr className="border-b border-stone-200 bg-stone-50 dark:border-stone-700 dark:bg-stone-900">
									<th className="px-4 py-3 text-left font-semibold text-stone-900 dark:text-stone-100">
										Operation
									</th>
							...
							<tbody>
								{(
									["workspace", "save", "version", "review", "deliver"] as const
								).map((op) => (
									<tr
										key={op}
										className="border-b border-stone-100 dark:border-stone-800"
									>
										<td className="px-4 py-3 font-medium text-stone-700 dark:text-stone-300 capitalize">
											{op === "workspace" ? "Create workspace" : op}
										</td>
										{persistenceAdapters.map((adapter) => (
											<td
												key={adapter.name}
												className="px-4 py-3 font-mono text-xs text-stone-500 dark:text-stone-400"
											>
					...
					<div className="mt-6 rounded-xl border border-teal-200 bg-teal-50 p-5 dark:border-teal-800 dark:bg-teal-950/20">
						<p className="text-sm text-teal-800 dark:text-teal-200">
							<strong>This is what makes H·AI·K·U domain-agnostic.</strong> The
							core loop (elaborate, execute, review, gate) is universal.
							Persistence adapts to the environment automatically — git repos
							get commits and PRs, everything else gets files on disk.
						</p>
					</div>
				</div>
			</section>
			...
			<section className="border-y border-stone-200 bg-stone-50 px-4 py-16 dark:border-stone-800 dark:bg-stone-900/50">
				<div className="mx-auto max-w-5xl">
					<div className="mb-10 text-center">
						<h2 className="mb-3 text-3xl font-bold">Knowledge Architecture</h2>
						<p className="mx-auto max-w-2xl text-stone-600 dark:text-stone-400">
							Every stage reads from two layers of accumulated context. This
							ensures no information is lost between stages or sessions.
						</p>
					</div>
						...
						<div className="rounded-xl border-2 border-dashed border-cyan-300 bg-cyan-50/30 p-6 dark:border-cyan-800 dark:bg-cyan-950/10">
							...
							<div className="flex flex-wrap gap-2">
								{[
									...
									<span
										key={file}
										className="rounded-lg border border-cyan-200 bg-white px-3 py-1.5 font-mono text-xs text-cyan-700 dark:border-cyan-800 dark:bg-cyan-950 dark:text-cyan-300"
									>
										{file}
									</span>
								))}
			...
			<section className="px-4 py-16">
				<div className="mx-auto max-w-5xl">
					<div className="mb-10 text-center">
						...
						<p className="mx-auto max-w-2xl text-stone-600 dark:text-stone-400">
							Everything in H·AI·K·U flows through two commands. Here&apos;s
						...
						<div className="rounded-xl border-2 border-teal-200 bg-teal-50/20 p-6 dark:border-teal-800 dark:bg-teal-950/10">
							...
							<div className="mb-4">
								...
								<div className="grid gap-3 md:grid-cols-3">
									{[
										...
										<div
											key={step.label}
											className="rounded-lg border border-teal-200 bg-white p-4 dark:border-teal-800 dark:bg-stone-950"
										>
							...
							<div>
								<div className="mb-3 flex items-center gap-2">
									...
									<span className="text-sm font-semibold text-stone-700 dark:text-stone-300">
										First Stage Begins Automatically
									</span>
								</div>
								<div className="grid gap-3 md:grid-cols-4">
									{[
										...
										<div
											key={step.label}
											className="rounded-lg border border-teal-200/60 bg-teal-50/40 p-4 dark:border-teal-800/60 dark:bg-teal-950/20"
										>
											<div className="mb-2 flex items-center gap-2">
												<span className="text-teal-600 dark:text-teal-400">
													{step.icon}
								...
								<p className="mt-3 text-xs text-stone-500 dark:text-stone-400">
									The first stage varies by studio &mdash; inception for
									software, research for ideation &mdash; but it always does the
									deep elaboration work: discovery, elaboration, and criteria
									definition.
								</p>
							</div>
						...
						<div className="rounded-xl border-2 border-indigo-200 bg-indigo-50/20 p-6 dark:border-indigo-800 dark:bg-indigo-950/10">
							...
							<div className="grid gap-4 md:grid-cols-3">
								<div className="rounded-lg border border-indigo-200 bg-white p-4 dark:border-indigo-800 dark:bg-stone-950">
									...
									<p className="text-xs text-stone-600 dark:text-stone-400">
										Reads STAGE.md for hat sequence. Loads prior stage outputs +
										global knowledge. Resolves units from DAG.
									</p>
								</div>
								<div className="rounded-lg border border-indigo-200 bg-white p-4 dark:border-indigo-800 dark:bg-stone-950">
									<div className="mb-2 flex items-center gap-2">
									...
									<p className="text-xs text-stone-600 dark:text-stone-400">
										Spawns fresh agents for each hat in the stage&apos;s
										sequence. Each hat works on units, advancing through the
										DAG. Failed reviews loop back.
									</p>
								</div>
								<div className="rounded-lg border border-indigo-200 bg-white p-4 dark:border-indigo-800 dark:bg-stone-950">
									<div className="mb-2 flex items-center gap-2">
									...
									<p className="text-xs text-stone-600 dark:text-stone-400">
										All units done. Review gate fires:{" "}
										<span className="text-green-600">auto</span> advances,{" "}
										<span className="text-amber-600">ask</span> pauses for user,{" "}
										<span className="text-cyan-600">await</span> waits for async
										signal, <span className="text-rose-600">external</span>{" "}
										blocks for team.
									</p>
								</div>
							</div>
							...
							<div className="mt-4 rounded-lg bg-indigo-100/50 p-3 text-xs text-indigo-800 dark:bg-indigo-900/20 dark:text-indigo-200">
								<strong>Delivery:</strong> After the final stage, the work is
								delivered based on environment &mdash; in git repos, a PR is
								opened; otherwise, output stays local.
							</div>
						</div>
					</div>
				</div>
			...
			<section className="border-y border-stone-200 bg-stone-50 px-4 py-16 dark:border-stone-800 dark:bg-stone-900/50">
				<div className="mx-auto max-w-5xl">
					<div className="mb-10 text-center">
						<h2 className="mb-3 text-3xl font-bold">Full Hierarchy</h2>
						<p className="mx-auto max-w-2xl text-stone-600 dark:text-stone-400">
						...
						<div className="font-mono text-sm leading-loose">
							<div>
								...
								<span className="text-stone-400">
									{" "}
									— named lifecycle for any domain (software, marketing,
									hardware, ...)
								</span>
							</div>
							<div className="ml-4">
								...
								<span className="text-stone-400">
									{" "}
									— how work is saved (git, notion, filesystem, ...)
								</span>
							</div>
							<div className="ml-4">
								<span className="text-stone-300 dark:text-stone-600">|-- </span>
								...
								<span className="text-stone-400">
									{" "}
									— lifecycle phase: plan, build, review
								</span>
							</div>
							<div className="ml-8">
								<span className="text-stone-300 dark:text-stone-600">|-- </span>
								...
								<span className="text-stone-400">
									{" "}
									— hats, guidance, review mode, requires/produces
								</span>
							</div>
							<div className="ml-8">
								<span className="text-stone-300 dark:text-stone-600">|-- </span>
							...
							<div className="ml-8">
								...
								<span className="text-stone-400">
									{" "}
									— discrete piece of work with criteria
								</span>
							</div>
							<div className="ml-12">
								<span className="text-stone-300 dark:text-stone-600">|-- </span>
								...
								<span className="text-stone-400">
									{" "}
									— one cycle through the stage&apos;s hat sequence
								</span>
							</div>
						</div>
					</div>
			...
			<section className="px-4 py-16">
				<div className="mx-auto max-w-5xl">
					<div className="mb-10 text-center">
						<h2 className="mb-3 text-3xl font-bold">Continuous vs Discrete</h2>
						<p className="mx-auto max-w-2xl text-stone-600 dark:text-stone-400">
							Two execution styles. Same pipeline, same quality, different
							...
							<div className="space-y-1.5">
								{[
									...
									},
									{
										...
										gate: "external",
										gateLabel: "team decides: do we build this?",
									},
									{
										stage: "development",
										color:
									...
									},
									{
										...
										gate: "auto",
										gateLabel: "advances immediately",
									},
									{
										stage: "security",
										color:
										...
										gate: "external",
										gateLabel: "team signs off (ask in autopilot)",
									},
								].map((s) => (
									<div key={s.stage}>
										<div className="flex items-center gap-2">
											<span
												className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-green-200 dark:bg-green-800"
												title="AI drives"
											>
												<svg
										...
										<div className="ml-2.5 flex items-center gap-2 border-l-2 border-dashed border-stone-200 py-1 pl-4 dark:border-stone-700">
											<span
												className={`h-2 w-2 rounded-full ${s.gate === "auto" ? "bg-green-400" : s.gate === "ask" ? "bg-amber-400" : "bg-rose-400"}`}
											/>
											<span
												className={`text-[10px] font-medium ${s.gate === "auto" ? "text-green-600 dark:text-green-400" : s.gate === "ask" ? "text-amber-600 dark:text-amber-400" : "text-rose-600 dark:text-rose-400"}`}
											>
								...
								<div className="flex items-center gap-2 pt-1">
									<span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-teal-200 dark:bg-teal-800">
										<svg
											className="h-3 w-3 text-teal-700 dark:text-teal-300"
											fill="none"
											viewBox="0 0 24 24"
											stroke="currentColor"
											aria-hidden="true"
									...
									<span className="text-[10px] text-stone-400">
										delivers based on environment (PR in git, local otherwise)
									</span>
								</div>
							</div>
						</div>
							...
							<div className="space-y-1.5">
								{[
									...
									<div key={s.stage}>
										<div className="flex items-center gap-2">
											<span
												className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-purple-200 dark:bg-purple-800"
												title="Human invokes"
											>
												<svg
					...
					<div className="mt-8 rounded-xl border border-stone-200 bg-white p-6 dark:border-stone-800 dark:bg-stone-950">
						...
						<p className="mb-4 text-sm text-stone-600 dark:text-stone-400">
							Each stage declares a review mode that controls what happens at
							its boundary. These modes enable everything from fully autonomous
							pipelines to multi-person handoff workflows.
						</p>
						<div className="grid gap-4 md:grid-cols-3">
							<div className="rounded-lg border-2 border-green-200 bg-green-50/30 p-4 dark:border-green-800 dark:bg-green-950/10">
								<div className="mb-2 flex items-center gap-2">
								...
								<p className="text-xs text-stone-600 dark:text-stone-400">
									The AI verifies all criteria are met and advances immediately.
									Used for stages where machines can fully validate quality —
								...
								<div className="mt-3 rounded bg-green-100 p-2 text-[10px] text-green-700 dark:bg-green-900/30 dark:text-green-300">
									Example: operations stage — deployment config either validates
									or it doesn&apos;t
								</div>
							</div>
							<div className="rounded-lg border-2 border-amber-200 bg-amber-50/30 p-4 dark:border-amber-800 dark:bg-amber-950/10">
								...
								<p className="text-xs text-stone-600 dark:text-stone-400">
									The pipeline pauses and presents the output for the current
									user to review. An internal checkpoint — the person driving
									the work validates before moving on.
								</p>
								<div className="mt-3 rounded bg-amber-100 p-2 text-[10px] text-amber-700 dark:bg-amber-900/30 dark:text-amber-300">
									Example: &ldquo;Does this design look right before we build
									it?&rdquo;
								</div>
							</div>
							<div className="rounded-lg border-2 border-rose-200 bg-rose-50/30 p-4 dark:border-rose-800 dark:bg-rose-950/10">
								...
								<p className="text-xs text-stone-600 dark:text-stone-400">
									The pipeline fully stops and waits for sign-off from someone
									outside the current session. Enables handoffs — a designer
									finishes, a tech lead reviews, an engineer picks up the next
									stage.
								</p>
								<div className="mt-3 rounded bg-rose-100 p-2 text-[10px] text-rose-700 dark:bg-rose-900/30 dark:text-rose-300">
									Example: product owner approves the spec before engineering
									starts
								</div>
							</div>
						</div>
