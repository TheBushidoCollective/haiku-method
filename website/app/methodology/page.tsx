			...
			<section className="mb-12">
				...
				<div className="mb-6 flex justify-center">
					<Mermaid
						...
						chart={`graph LR
	E[Elaboration] --> X[Execution]
	X --> O[Operation]
	O --> R[Reflection]
	R -.->|Feed Forward| E
	style E fill:#f0fdfa,stroke:#99f6e4,color:#134e4a
	style X fill:#eef2ff,stroke:#c7d2fe,color:#312e81
	style O fill:#fffbeb,stroke:#fde68a,color:#78350f
	style R fill:#fff1f2,stroke:#fecdd3,color:#881337`}
					/>
				</div>
