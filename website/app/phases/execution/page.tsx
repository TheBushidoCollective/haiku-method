			...
			<section className="mb-10">
				...
				<div className="mt-4">
					<Mermaid
						...
						chart={`graph LR
	subgraph Default
		P1[Planner] --> E1[Executor] --> R1[Reviewer]
	end
	subgraph Adversarial
		P2[Planner] --> E2[Executor] --> C2[Challenger] --> D2[Defender] --> R2[Reviewer]
	end
	subgraph Exploratory
		O3[Observer] --> H3[Hypothesizer] --> X3[Experimenter] --> A3[Analyst]
	end`}
					/>
				</div>
			</section>
			...
			<section className="mb-10">
				...
				<Mermaid
					className="w-full"
					chart={`flowchart TD
	P[Planner creates execution plan] --> E[Executor produces deliverable]
	E --> QG{Quality gates}
	QG -->|Pass| RV{Reviewer evaluates}
	QG -->|Fail| E
	RV -->|Accepted| SC{Success criteria met?}
	RV -->|Revisions needed| E
	SC -->|Yes| Done[Unit complete]
	SC -->|No| P
	E -->|Stuck| H[Escalate to human]`}
				/>
			</section>
