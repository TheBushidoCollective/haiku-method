...
<Callout tone="warn" title="The failure mode both projects exist to address">
Long-running agents produce worse output as their context window fills up. Steps two through seven start drifting from step one. Neither project disputes the diagnosis; we just disagree about where to put the fix.
</Callout>
