...
<Callout tone="info" title="The shared insight">
A specialist beats a generalist. GSTACK puts the specialist in a role prompt the user picks. We put the specialist in a hat the engine picks. Same lever, different layer of the stack.
</Callout>
