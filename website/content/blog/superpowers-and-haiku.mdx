...
<Grid>
  ...
  <Card eyebrow="Distribution" title="Works with any AI agent, not just Claude" accent="info">
    The core tooling speaks MCP — the open protocol AI agents use to call outside tools. Any agent that speaks it can drive a H·AI·K·U run today: Cursor, Codex, Copilot CLI, Gemini, Claude. The Claude-specific slash commands (`/haiku:haiku-start`, `/haiku:resume`) are convenient wrappers; they aren't the product.
  </Card>
