...
<Callout tone="info" title="The shared diagnosis">
Both projects look at the raw coding agent and say "needs discipline." Superpowers gives discipline to the human-agent partnership. We give discipline to the agent so the partnership can dial up or down. Same patient, different prescription.
</Callout>
...
<Compare verdict="diverge" title="The surface for non-developers">
  <Side label="Superpowers">
