...
When you run `/haiku:haiku-start` outside of a git repo, H·AI·K·U detects this and enters cowork mode:
...
The `/haiku:haiku-pickup` skill handles cowork transparently:
