...
By explicitly switching hats, you maintain focus and ensure each phase gets proper attention. Domain research happens during inception (`/haiku:haiku-start`), before execution begins.
...
Hats used during `/haiku:haiku-start` to define the intent and elaborate work.
